...
import {useThemeSwitcher} from "@/Composable/useThemeSwitcher";
import Dropdown from "@/Components/Dropdown.vue";
import DropdownLink from "@/Components/DropdownLink.vue";

defineProps<{ currentTheme: Theme }>()
defineEmits(['setTheme'])

const {systemPreferred} = useThemeSwitcher();
  ...
  <Dropdown align="right" width="48">
    <template #trigger>
      <div class="flex align-center">
        <div class="inline-flex" :class="{ 'dark:text-gray-400 ': currentTheme === 'dark' }">
          ...
          <svg v-else-if="systemPreferred === 'light'" viewBox="0 0 24 24" fill="none" stroke-width="2"
               stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 mr-2">
        ...
        <div class="block sm:hidden w-full border-l-4 border-transparent text-left text-base font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out">Theme</div>
      </div>
    </template>
    <template #content>
      <DropdownLink @click="$emit('setTheme','light')" href="#">
      ...
      <DropdownLink @click="$emit('setTheme','dark')" href="#">
      ...
      <DropdownLink @click="$emit('setTheme','system')" href="#">
